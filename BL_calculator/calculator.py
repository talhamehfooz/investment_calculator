...
def calculate_investment(plan, investment_amount, chosen_profit_rate):
    ...
    # Calculate monthly return and total profit
...
# Step 5: Optional action buttons for additional actions
...
with col3:
    if st.button("Start New Calculation"):
        st.experimental_rerun()  # Restart the app for a new calculation
